...
pipelines offering both headless and non-headless crawling.`)
	...
	flagSet.CreateGroup("output", "Output",
		...
		flagSet.BoolVarP(&options.OmitRaw, "omit-raw", "or", false, "omit raw requests/responses from output"),
		flagSet.BoolVarP(&options.OmitBody, "omit-body", "ob", false, "omit response body from output"),
