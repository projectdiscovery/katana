...
pipelines offering both headless and non-headless crawling.`)
	...
	flagSet.CreateGroup("config", "Configuration",
		...
		flagSet.StringSliceVar(&options.PathFuzzDict, "path", nil, "path or list of paths to use for fuzzing and crawling paths (comma-separated, file)", goflags.FileCommaSeparatedStringSliceOptions),
		flagSet.BoolVarP(&options.DisableDefaultCrawl, "disable-default-crawl", "ddc", false, "disable default automatic crawling"),
