...
func readFlags() (*goflags.FlagSet, error) {
	...
	flagSet.CreateGroup("headless", "Headless",
		...
		flagSet.StringVarP(&options.CrawlStrategy, "crawl-strategy", "cstr", "", "crawl intensity preset for headless (fast, balanced, thorough)"),
		flagSet.IntVarP(&options.DOMWaitTime, "dom-wait-time", "dwt", 5, "time in seconds to wait after page load when using domcontentloaded strategy (0 disables)"),
