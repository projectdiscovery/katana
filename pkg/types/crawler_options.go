...
func NewCrawlerOptions(options *Options) (*CrawlerOptions, error) {
	...
	outputWriter, err := output.New(!options.NoColors, options.JSON, options.Verbose, options.StoreResponse, options.OutputFile, options.Fields, options.StoreFields, options.StoreResponseFolder)
	if err != nil {
