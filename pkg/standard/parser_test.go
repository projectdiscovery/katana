...
func TestHeaderParsers(t *testing.T) {
	...
	t.Run("content-location", func(t *testing.T) {
		var gotURL string
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}, Header: http.Header{"Content-Location": []string{"/test/headers/content-location.found"}}}}
		headerContentLocationParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
	...
	t.Run("link", func(t *testing.T) {
		var gotURL string
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}, Header: http.Header{"Link": []string{"</test/headers/link.found>; rel=\"preload\""}}}}
		headerLinkParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
	...
	t.Run("location", func(t *testing.T) {
		var gotURL string
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}, Header: http.Header{"Location": []string{"http://security-crawl-maze.app/test/headers/location.found"}}}}
		headerLocationParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
	...
	t.Run("refresh", func(t *testing.T) {
		var gotURL string
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}, Header: http.Header{"Refresh": []string{"999; url=/test/headers/refresh.found"}}}}
		headerRefreshParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
...
func TestBodyParsers(t *testing.T) {
	...
	t.Run("a", func(t *testing.T) {
		...
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}}, Reader: documentReader}
		bodyATagParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
	...
	t.Run("embed", func(t *testing.T) {
		...
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}}, Reader: documentReader}
		bodyEmbedTagParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
	...
	t.Run("frame", func(t *testing.T) {
		...
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}}, Reader: documentReader}
		bodyFrameTagParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
	...
	t.Run("iframe", func(t *testing.T) {
		...
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}}, Reader: documentReader}
		bodyIframeTagParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
	...
	t.Run("input", func(t *testing.T) {
		...
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}}, Reader: documentReader}
		bodyInputSrcTagParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
	...
	t.Run("isindex", func(t *testing.T) {
		...
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}}, Reader: documentReader}
		bodyIsindexActionTagParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
	...
	t.Run("script", func(t *testing.T) {
		...
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}}, Reader: documentReader}
		bodyScriptSrcTagParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
	...
	t.Run("button", func(t *testing.T) {
		...
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}}, Reader: documentReader}
		bodyButtonFormactionTagParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
	...
	t.Run("form", func(t *testing.T) {
		t.Run("get", func(t *testing.T) {
			...
			resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}}, Reader: documentReader}
			bodyFormTagParser(resp, func(resp navigation.NavigationRequest) {
				gotURL = resp.URL
			})
	...
	t.Run("meta-refresh", func(t *testing.T) {
		...
		resp := navigation.NavigationResponse{Resp: &http.Response{Request: &http.Request{URL: parsed}}, Reader: documentReader}
		bodyMetaContentTagParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
...
func TestScriptParsers(t *testing.T) {
	...
	t.Run("content", func(t *testing.T) {
		...
		resp := navigation.NavigationResponse{Options: &types.CrawlerOptions{Options: &types.Options{ScrapeJSResponses: true}}, Resp: &http.Response{Request: &http.Request{URL: parsed}}, Reader: documentReader}
		scriptContentRegexParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
	...
	t.Run("js", func(t *testing.T) {
		...
		var gotURL string
		resp := navigation.NavigationResponse{Options: &types.CrawlerOptions{Options: &types.Options{ScrapeJSResponses: true}}, Resp: &http.Response{Request: &http.Request{URL: parsed}}, Body: []byte("var endpoint='/test/html/script/body.do';")}
		scriptJSFileRegexParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
		...
		parsed, _ = url.Parse("https://security-crawl-maze.app/html/script/xyz/")
		gotURL = ""
		resp = navigation.NavigationResponse{Options: &types.CrawlerOptions{Options: &types.Options{ScrapeJSResponses: true}}, Resp: &http.Response{Request: &http.Request{URL: parsed}, Header: http.Header{"Content-Type": []string{"application/javascript"}}}, Body: []byte("var endpoint='/test/html/script/body-content-type.do';")}
		scriptJSFileRegexParser(resp, func(resp navigation.NavigationRequest) {
			gotURL = resp.URL
		})
